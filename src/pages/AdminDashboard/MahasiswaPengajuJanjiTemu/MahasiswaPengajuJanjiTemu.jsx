...
const MahasiswaPengajuJanjiTemu = () => {
    ...
    const fetchMahasiswa = async () => {
        try {
            const response = await api.get("/mahasiswa/janji-temu");
    ...
    return (
        <>
            <PageMeta
                title="Konseling PENS Dashboard | Mahasiswa"
                description="Halaman kelola data mahasiswa pengaju janji temu"
            />
...
export default MahasiswaPengajuJanjiTemu;
