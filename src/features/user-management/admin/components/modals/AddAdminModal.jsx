...
export default function AddAdminModal({ isOpen, closeModal, onSubmitSuccess }) {
    ...
    const handleSubmit = async () => {
        ...
        if (!formData.nama_lengkap || !formData.email || !formData.phoneNumber || !formData.password) {
        ...
        try {
            await api.post("/admin/account", formData);
