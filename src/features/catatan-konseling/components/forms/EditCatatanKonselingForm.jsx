...
export default function EditCatatanKonselingForm({
    konselingDetails,
    catatanKonselingDetails,
    onSubmit,
    loading,
}) {
    ...
    useEffect(() => {
        if (catatanKonselingDetails) {
            setFormData({
                deskripsi_masalah: catatanKonselingDetails.deskripsi_masalah || "",
                usaha: catatanKonselingDetails.usaha || "",
                kendala: catatanKonselingDetails.kendala || "",
                pencapaian: catatanKonselingDetails.pencapaian || "",
                diagnosis: catatanKonselingDetails.diagnosis || "",
                intervensi: catatanKonselingDetails.intervensi || "",
                tindak_lanjut: catatanKonselingDetails.tindak_lanjut || "",
                konseling_lanjutan: catatanKonselingDetails.konseling_lanjutan || false,
            });
        }
    }, [catatanKonselingDetails]);
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <Info
                                label="Tanggal"
                                value={new Date(
                                    konselingDetails.tanggal_konseling
                            ...
                            <Info
                                label="Jam"
                                value={`${konselingDetails.jam_mulai} - ${konselingDetails.jam_selesai}`}
                            />
            ...
            <div>
                ...
                >
                    {loading ? "Menyimpan..." : "Update Catatan Konseling"}
                </button>
            </div>
        </form>
    );
