...
export default function EditCatatanKonselingForm({ konselingId, catatanKonselingId = null }) {
        ...
        const fetchCatatan = async () => {
            try {
                ...
                setFormData({
                    ...
                    konseling_lanjutan: data.konseling_lanjutan || false,
                    konseling_selesai: data.konseling_selesai || false,
                });
            } catch (error) {
                console.error("Gagal memuat catatan konseling:", error);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            response = await api.put(`/catatan-konseling/${catatanKonselingId}`, payload);

            if (response.status === 200 || response.status === 201) {
                Swal.fire({
                    title: "Success",
                    text: "Catatan Konseling Berhasil Diperbarui!",
                    icon: "success",
                    confirmButtonText: "OK"
                });
                setTimeout(() => {
