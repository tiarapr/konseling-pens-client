...
export default function InfoCatatanKonseling({ catatanKonselingId }) {
    ...
    if (!catatanKonseling) return <div>Loading...</div>;  // Jika data belum ada, tampilkan loading

    // Redirect to edit page when "Edit" button is clicked
    const handleEdit = () => {
        navigate(`/konselor-dashboard/konseling/${catatanKonseling.konseling_id}/catatan/${catatanKonseling.id}`);
    };
    ...
    return (
        <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                ...
                <button
                    onClick={handleEdit}  // Trigger the redirect to the edit page
